	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				...
				<a href="#" class="navbar-brand">LI Vente</a>
			</div>
		<div class="collapse navbar-collapse" id="collapse">
			<ul class="nav navbar-nav">
				<li><a href="index.php"><span class="glyphicon glyphicon-home"></span>Home</a></li>
				<li><a href="presonelcard/index.html"><span class="glyphicon glyphicon-modal-window">
					
				</span>Cart Personel</a></li>
			...
			<div class="col-md-8">	
				...
				<div class="panel panel-info" id="scroll">
					...
					<div 
                     ...
                     <p class="text-white text-center p-5 mt-4">
					 class="panel-footer">&copy; 2021
